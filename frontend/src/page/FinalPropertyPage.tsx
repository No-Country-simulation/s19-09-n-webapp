import { Box, Typography, Grid2, Button, Paper, Divider } from "@mui/material";
...
const propiedad: Propiedad = {
  ...
  descripcion:
    "DUEÑO ALQUILA AMPLIO DEPARTAMENTO DE 3 AMBIENTES AL CONTRAFRENTE CON LINDO BALCÓN. Muy buena circulación, silencioso y luminoso con vista abierta. Baño y cocina hechos a nuevo.",
  servicios: [
    "Agua",
    "Luz",
    "Gas",
        ...
        <Grid2 size={{ xs: 12, md: 6 }}>
          ...
          <Paper sx={{ height: 300 }}>
            <Typography variant="h6">
              Mapa - Ubicación: {propiedad.ubicacion.lat},{" "}
